...
\subsection{Xác định số lượng sinh viên: }
\newpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \section{Phần 4 Hiện thi các kết quả Kiểm thử}
    ...
    \subsection{Test case3}
    \subsection{Test case cho phần 4}
    \subsubsection{test}
    asdfsdfsafsafdsfsadfsdafsdagasdgdsgsadgsadgsag
    agsadgsagadsgsagdsgsdgsdgsadgsgsdgdsgsdgsdgsagasgsdg
    safgdsfsdagsdgdsagdsgsagsagdsgsdgsagsasgsgsda
