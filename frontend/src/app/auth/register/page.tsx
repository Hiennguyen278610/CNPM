            ...
            <div className="w-full h-4/5 bg-transparent !p-5 flex-nesw">
                <div className='w-full h-full flex-nesw'>
                    <form action="" className='w-full h-max flex-nesw flex-col !p-5 gap-4 text-center'>
                            ...
                            <input type="text" placeholder="Email" className="w-full rounded-xl !p-4 bg-secondary" />
                            <input type="text" placeholder="Phone Number" className="w-full rounded-xl !p-4 bg-secondary" />
                            <input type="password" placeholder="Password" className="w-full rounded-xl !p-4 bg-secondary" />
                            <input type="password" placeholder="Confirm your password" className="w-full rounded-xl !p-4 bg-secondary" />
