...
try {
  // Cập nhật file .env.local với địa chỉ IP mới
  fs.writeFileSync('d:\\Workspace\\cnpmProject\\frontend\\.env.local', `IPURL=${ipv4}`, { flag: 'w' });
  console.log('Đã cập nhật file .env.local với địa chỉ IP hiện tại');
} catch (error) {
